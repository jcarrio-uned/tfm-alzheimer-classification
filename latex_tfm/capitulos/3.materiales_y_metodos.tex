...
al.~\parencite{bernal2025metabolomics}, que aquí se adopta como entrada analítica de partida. La diferencia respecto a los 139 casos del artículo no
...
\begin{itemize}
    ...
    \item \textbf{Trastorno cardiovascular}: comorbilidad cardiovascular considerada en el segundo escalón del sistema.
...
\hline
Sujetos totales ($n$) & 148 \\
AD & 89 (60,1\%) \\
NC & 59 (39,9\%) \\
Variables metabolómicas ($p$) & 20 residuales \\
Valores faltantes & 0 \\
Ratio AD:NC & 1,51:1 \\
Ratio $n/p$ & 7,4 \\
EPV (clase minoritaria / $p$) & 3,0 \\
\hline
\end{tabular}
\end{table}
...
Bajo ese criterio se inspeccionaron MMSE, APOE, depresión, trastorno cardiovascular y edad, prestando especial atención a que ninguna
...
trastorno cardiovascular y edad, aunque la selección final dentro de ese conjunto se reserva para el capítulo de resultados.
